...
class Network(nn.Module):
    ...
    def __init__(self, channel=32, imagenet_pretrained=True):
        ...
        # Freeze layers except Reverse Stage
        for param in self.resnet.parameters():
            param.requires_grad = False
        for param in self.rfb2_1.parameters():
            param.requires_grad = False
        for param in self.rfb3_1.parameters():
            param.requires_grad = False
        for param in self.rfb4_1.parameters():
            param.requires_grad = False
        for param in self.NCD.parameters():
            param.requires_grad = False
