...
class Net(nn.Module):
    def __init__(self):
        ...
        # Freeze layers except CAM and predictors
        for param in self.resnet.parameters():
            param.requires_grad = False
        for param in self.eam.parameters():
            param.requires_grad = False
        for param in self.efm1.parameters():
            param.requires_grad = False
        for param in self.efm2.parameters():
            param.requires_grad = False
        for param in self.efm3.parameters():
            param.requires_grad = False
        for param in self.efm4.parameters():
            param.requires_grad = False
